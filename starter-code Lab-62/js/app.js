...
CookieStand.prototype.render = function() {
  // TODO: generate the calculation of cookies each hour here
this.calcCookiesEachHour();
  ...
  //1. get the parent
  //2. create the element to display
  //3. assign the property to the newly created elementr (text)
  //4. append/attach to parent
...
// Seattle, 12, 24, 5 - make use of CookieStand Constructor
// Redmond, 15, 28, 4
// Prineville, 10, 20, 6



var seattle = new CookieStand("Seattle", 12, 24, 5);
var redmond = new CookieStand("Redmond", 15, 28, 4)
var prineville = new CookieStand("Prineville", 10, 20, 6)
